...
def test_openai_response_parser_supports_content_blocks():
    from app.services.extraction_llm_client import _extract_response_text
        ...
        "choices": [
            {
                "message": {
                    "content": [
                        {
                            "type": "text",
                            "text": '{"topic":"other","entities":{"countries":[],"orgs":[],"people":[],"tickers":[]},'
                            '"affected_countries_first_order":[],"market_stats":[],"sentiment":"unknown",'
                            '"confidence":0.2,"impact_score":1.0,"is_breaking":false,"breaking_window":"none",'
                            '"event_time":null,"source_claimed":null,"summary_1_sentence":"x",'
                            '"keywords":[],"event_fingerprint":"abc"}',
                        }
                    ]
                }
            }
    ...
    out = _extract_response_text(body)
